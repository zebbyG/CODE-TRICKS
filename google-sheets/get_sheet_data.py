import json
import os
# Create <test_creds.json>
# Login to Gcloud, create OAuth client, download the json file and update the values on <test_creds.json>
...
TEST_SURVEY_SPREADSHEET_ID = '1wXpGHCCICG5Q9NdGQimZC_bra8xfBm-VRru42h7iWH4' # A unique ID to identify the sheet....[change it to your preferable sheet]
TEST_SURVEY_RANGE = '1:5107' # The range of values accessed in the sheet. [match the range of the sheet id specified above]
